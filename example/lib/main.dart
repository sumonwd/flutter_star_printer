      ...
      home: Scaffold(
        ...
        body: Column(
          children: <Widget>[
            TextButton(
              onPressed: () async {
                List<PortInfo> list = await FlutterStarPrinter.portDiscovery(StarPortType.All);
                if (kDebugMode) {
                  print(list);
                }
                list.forEach((port) async {
                  ...
                  if (port.portName?.isNotEmpty != null) {
                    if (kDebugMode) {
                      print(await FlutterStarPrinter.getStatus(
                    ...
                    print(await FlutterStarPrinter.sendCommands(
                        portName: port.portName!,
                        emulation: emulationFor(port.modelName!),
