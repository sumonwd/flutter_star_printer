...
import 'package:flutter_star_printer/src/printer_response_status.dart';

/// Class to handle printer communication
class FlutterStarPrinter {
  static const MethodChannel _channel = MethodChannel('star_micronics_flutter');
  ...
  static Future<PrinterResponseStatus> getStatus({
    ...
    return PrinterResponseStatus.fromMap(Map<String, dynamic>.from(result));
  }
